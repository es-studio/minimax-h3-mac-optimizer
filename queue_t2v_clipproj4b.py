#!/usr/bin/env python3
"""Queue MiniMax H3 T2V with ClipProj 4B TE at 864x480 / 5s."""
...
OUT = Path("/Users/eunsung/minimax/t2v_clipproj4b.json")
...
prompt = {
    ...
    "92": {
        ...
        "inputs": {
            "video": ["12", 0],
            "filename_prefix": "video/MiniMax_H3_T2V_clipproj4b_864x480_5s",
            "format": "auto",
            "codec": "auto",
        },
    },
        ...
        json.dumps(
            {
                ...
                "settings": "T2V 864x480 5s 20steps ClipProj 4B fp8 + v3-mlp",
